...
class FastMriDataModule(pl.LightningDataModule):
    ...
    def __init__(
        ...
        use_mid_slices: bool =True, 
        num_mid_slices: int =24, 
        fat_supress: bool =False, 
        strength_3T: bool =True, 
        restrict_size: bool =False,
    ):
        """
        Args:
        ...
        self.use_mid_slices =  use_mid_slices
        self.num_mid_slices = num_mid_slices
        self.fat_supress= fat_supress 
        self.strength_3T= strength_3T 
    ...
    def _create_data_loader(
        ...
        if is_train and self.combine_train_val:
            ...
            dataset = CombinedSliceDataset(
                ...
                use_mid_slices =  self.use_mid_slices,
                num_mid_slices = self.num_mid_slices,
                fat_supress= self.fat_supress,
                strength_3T= self.strength_3T,
    ...
    def add_data_specific_args(parent_parser):  # pragma: no-cover
        ...
        parser.add_argument(
            ...
            default=True,
            type=bool,
            help="Whether to use mid sliecs",
        )
        parser.add_argument(
            "--num_mid_slices",
            default=24,
            type=int,
            help="Number of mid slices to use",
        )
        ...
        parser.add_argument(
            ...
            default=False,
            type=bool,
            help="Whether to use only fat supressed data",
        )
        ...
        parser.add_argument(
            ...
            default=True,
            type=bool,
            help="Whether to use only 3 T scans",
        )
